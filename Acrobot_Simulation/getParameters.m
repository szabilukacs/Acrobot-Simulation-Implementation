...
%q1_m = out.q1_m.Data; % encodertol szamolt
%dq1_m = out.dq1_m.Data;
...
%switch_state_nn = out.switch_controller_state_nn.Data;
E = out.E.Data;

%ide beirni a kimentetteket
